            ...
            <Section bgImg={"bg-sun.png"}>
                <Stack className="pt-section-gap" gap="gap-section-gap">
                    ...
                    <div className="flex flex-col items-center gap-[55px] mt-[120px] md:flex-row">
                        <h2 className="order-1 md:hidden text-center font-bowlby text-brand-blue text-section-title">Match</h2>
                        ...
                        <h2 className="order-3 md:hidden text-center font-bowlby text-brand-blue text-section-title">to</h2>
            ...
            <Section bgImg={"bg-sun-reversed.png"}>
                <Stack className="pt-section-gap" gap="gap-section-gap">
                    ...
                    <Stack className="md:flex-row">
                        ...
                        <Stack>
                            <p className="font-poppins text-[#061826] text-description-md pt-[62px]">Arrived at the festival? Check out all of the activities<br />you can engage with at the festival.</p>
                            <a className="bg-[#F45348] text-[#EDF5FC] text-button-md font-bowlby mt-[92px] px-[40px] py-[10px] rounded-[15px] cursor-pointer w-full text-center">Become volunteer</a>
                            <a className="bg-[#F45348] text-[#EDF5FC] text-button-md font-bowlby px-[40px] py-[10px] rounded-[15px] cursor-pointer w-full text-center">Get free drinks</a>
                        </Stack>
                    </Stack>
                </Stack>
            </Section>
            ...
            <Section bgImg={"bg-footer.png"} className={"justify-end"} >
                <div className="flex justify-between">
                    ...
                    <div className="flex items-end gap-[9px] px-[127px] py-[91px] gap-[46px]">
                        <div className="flex items-center"><img className="h-[56px]" src="./instagram.png" alt="" /></div>
                        <div className="flex items-center"><img className="h-[79px]" src="./facebook.png" alt="" /></div>
                        <div className="flex items-center"><img className="h-[84px]" src="./youtube.png" alt="" /></div>
                        <div className="flex items-center"><img className="h-[57px]" src="./spotify.png" alt="" /></div>
                    </div>
                </div>
            </Section>
        </>
