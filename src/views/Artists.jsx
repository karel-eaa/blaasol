...
export function Artists() {
    return (
        <div className="flex min-h-screen flex-col bg-[#EDF5FC] text-[#061826]">
            <NavBar blue={true} />
            <ScheduleWidget />
            <ArtistSearchList artists={artists} />
            <Section bgImg="bg-sun.png" className="min-h-fit pt-12 pb-16">
                <h2 className="z-10 mb-2 text-center font-bowlby text-lg uppercase text-[#061826]">MATCH THE SONG</h2>
                <div className="z-10 w-full"><MatchSong /></div>
            </Section>
            <div className="flex bg-[#EDF5FC]">
